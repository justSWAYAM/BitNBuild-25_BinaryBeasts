    ...
    <div className="min-h-screen bg-slate-950 text-white overflow-hidden">
      ...
      <div className="relative z-40 px-6 lg:px-8 py-6">
        <div className="max-w-7xl mx-auto">
          <div className="relative bg-gradient-to-br from-slate-900/40 to-slate-800/60 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm font-medium">Find the perfect freelance opportunity</p>
                </div>
              </div>
              <div className="text-right">
                <div className="text-2xl font-bold text-emerald-400">{filteredJobs.length}</div>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-4 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-emerald-500/50 focus:bg-slate-800/70 transition-all duration-300"
                />
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                {(searchTerm || selectedCategory !== 'All' || budgetRange !== '') && (
                  <button
                    ...
                    className="px-4 py-2 bg-slate-800/50 border border-slate-700/50 rounded-xl text-slate-300 hover:text-white hover:border-emerald-500/50 transition-all duration-300 text-sm font-medium"
                  >
                    Clear Filters
                  </button>
                )}
        ...
        <div className="max-w-7xl mx-auto">
          {filteredJobs.length === 0 ? (
            <div className="text-center py-16">
              <div className="relative bg-gradient-to-br from-slate-900/40 to-slate-800/60 backdrop-blur-xl rounded-2xl border border-slate-700/30 p-12">
